...
var Runner = (function () {
    ...
    Runner.prototype.invert = function (reset) {
        if (reset) {
...
var GameOverPanel = (function () {
    ...
    ;
    GameOverPanel.prototype.updateDimensions = function (width, opt_height) {
...
var Trex = (function () {
    ...
    Trex.prototype.updateJump = function (deltaTime, speed) {
...
var NightMode = (function () {
    ...
    ;
    NightMode.prototype.update = function (activated, delta) {
    ...
    NightMode.prototype.updateXPos = function (currentPos, speed) {
...
var Horizon = (function () {
    ...
    Horizon.prototype.update = function (deltaTime, currentSpeed, updateObstacles, showNightMode) {
        this.runningTime += deltaTime;
    ...
    Horizon.prototype.duplicateObstacleCheck = function (nextObstacleType) {
