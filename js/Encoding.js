define(["require", "exports", "./Corelib"], function (require, exports, Corelib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ;
    Corelib_1.encoding.SerializationContext.GlobalContext.Register(Number, {
    ...
    Corelib_1.encoding.SerializationContext.GlobalContext.Register(Date, {
        FromJson: function (a, c) {
            if (a == null)
                return null;
            if (typeof a === 'number')
    ...
    var TextDecoder = /** @class */ (function () {
        ...
        TextDecoder.prototype.decode = function (ar) {
        };
        return TextDecoder;
    }());
