...
export enum Scops {
    ...
    invitable_friends,
    manage_pages,
    read_page_mailboxes/*, user_posts*/
}
var appTestID = '394907654315490';
var appID = '1619534588085111';
export class Facebook implements fb.AuthResponseData  {
    ...
    someApi() {
        var c = null; FB.login((r) => { debugger; }, { scope: 'public_profile,email,invitable_friends' });
    }
