import {$$, query, basic,bind,collection ,reflection,ScopicCommand} from "./../../js/corelib";
import { UI } from './../../js/UI';
import { context } from './../../js/context';
import { Material as side } from './../QSidebar/script';
import { Pages } from '../../Apps/Shop/Pages';
...
export module Material {
    ...
    export class App extends UI.IApp<UI.Page> {
        ...
        protected OnPageChanged(oldPage: UI.Page, page: UI.Page) {
            
        }
        protected Check(child: UI.Page | defs.UI.IPage) {
            return true;
        }
        private _getView(data?) {
            var tmp = UI.TControl.ToTemplate('templates.qui-app', false);
        ...
        initialize() {
            ...
            this.Pages = new collection.List<UI.Page>(Object, [new Pages.CostumersPage(this as any), new Pages.SearchPage(this as any), new Pages.FacturesPage(this as any), page]);
        ...
        static __fields__() { return [/*this.DPPages,*/ this.DPCategories, this.DPFastLinks, this.DPSuggestions, this.DPLogo]; }
    }
}