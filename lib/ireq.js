...
var t=setTimeout((function () {
    ...
    {        
        ...
        Module.prototype.OnError = function (e) {
            ...
            //console.logi("module " + this.FullName + ' failed to download');
        ...
        Module.prototype.idefine = function (dependencies, callback) {
            ...
            window['moduls'][this.FullName] = { mod: this, refs: [] };
            ...
            for (var i = 0, l = dependencies.length; i < l; i++) {
                ...
                if (d == "exports") {
                    ...
                    window['moduls'][this.FullName].refs.push(dm);
                }
            }
            this.Stat = ModuleStat.Defined;
            args.Invoke();
		...
		Module.Init = function () {
            ...
            for (var i = 0; i < scrs.length; i++) {
                ...
                if (app != undefined) {
                    globalContext.require(defaultUrl(app), function (o) { o.Start(); }, function (o) { alert('we cannot find app'); });
                }
                //if (app)
